...
A thorough understanding of corporate credit risk begins with fluency in the language of business: accounting. Financial statements are the primary source of information for any credit analyst, and their structure, content, and integrity are governed by a set of foundational rules.
...
While there has been significant convergence between GAAP and IFRS over the years, key differences remain in areas like inventory valuation, impairment recognition, and the treatment of development costs. For analysts dealing with multinational companies or comparing firms across different reporting regimes, understanding these differences is crucial. For instance, IFRS allows for the revaluation of Property, Plant & Equipment (PP&E) upwards, which GAAP generally prohibits (requiring historical cost).
...
*   **Revenues are recognized when they are earned** (i.e., when the company has substantially completed its performance obligations), regardless of when cash is received.
...
*   **Debt and Equity:**
    ...
    *   Repaying debt principal is a use of cash in CFF and decreases liabilities (Debt).
...
This interconnectedness is more than a mechanical accounting exercise; it is a powerful analytical tool. A persistent and significant divergence between a company's reported Net Income and its Cash Flow from Operations is one of the most potent early warning signs of deteriorating credit quality or aggressive accounting. A healthy company's profits should, over time, translate into cash. If a company consistently reports strong profits but generates weak or negative operating cash flow, it signals that its earnings are not being realized in cash. This could be due to aggressive revenue recognition, where sales are booked but customers aren't paying (rising Accounts Receivable), building up unsaleable inventory (rising Inventory), or delaying payments to suppliers (rising Accounts Payable, which is unsustainable long-term). For an analyst, this disconnect is a critical red flag that demands immediate investigation into the **quality of earnings**. The fundamental question becomes: "If the company is so profitable, where is the cash?"
...
*   **Cost of Goods Sold (COGS) / Cost of Services:** Direct costs related to producing goods or delivering services. For a manufacturer, this includes raw materials, direct labor, and manufacturing overhead. For a retailer, it's primarily the purchase cost of goods sold.
*   **Operating Expenses (OpEx):** Indirect costs required to run the business. These are typically broken down further:
    *   **Selling, General & Administrative (SG&A):** Includes salaries for non-production staff, marketing, rent for office space, utilities, legal fees.
    *   **Research & Development (R&D):** Costs associated with developing new products or services. The accounting for R&D can differ (e.g., expensed as incurred under GAAP for most R&D, while IFRS allows capitalization of some development costs).
    *   **Depreciation & Amortization (D&A):** Non-cash expenses that allocate the cost of tangible assets (depreciation for PP&E) and intangible assets (amortization for patents, software) over their useful lives.

Analyzing the trends in these expense categories as a percentage of revenue (common-size analysis) and year-over-year growth provides critical insights into a company's margin profile, cost control, and operating leverage.
...
*   **Note 1: Summary of Significant Accounting Policies:** This first note is critical. It discloses the specific accounting methods the company uses for important items like:
    ...
    *   Depreciation methods and estimated useful lives for PP&E.
...
*   **Debt Schedules:** This note provides a detailed breakdown of all outstanding debt (bonds, loans, credit facilities), including:
    *   Principal amounts.
    *   Maturity dates.
    *   Interest rates (fixed/floating, benchmark rates).
    *   Security/collateral pledged.
    *   Crucially, the terms of any **financial covenants** (e.g., leverage ratios, coverage ratios) and any defaults or waivers.
*   **Commitments and Contingencies:** This is where companies disclose potential future liabilities or obligations that are not yet recorded on the balance sheet but could have a material impact. Examples:
    *   Pending or threatened litigation (with estimates of potential loss, if possible).
    *   Loan guarantees provided to other entities.
    *   Long-term lease obligations (operating and finance leases under ASC 842).
    *   Environmental remediation liabilities.
    *   Unfunded pension obligations.
    These can represent significant "hidden" risks.
*   **Segment Information:** For large, diversified companies, this note breaks down key financial data (e.g., revenue, operating profit, assets) by reportable business segment and often by geographic region. This allows the analyst to understand which parts of the business are driving performance, which may be struggling, and the company's geographic diversification.
*   **Fair Value Measurements:** Details on how assets and liabilities carried at fair value (e.g., certain financial instruments) are measured, including the hierarchy of inputs used (Level 1, 2, or 3 – with Level 3 being the least observable and most subjective).
*   **Stock-Based Compensation:** Explains how the company accounts for options, restricted stock units (RSUs), and other equity awards granted to employees, including the assumptions used in valuation models.
*   **Income Taxes:** Reconciles the statutory tax rate to the company's effective tax rate and details deferred tax assets and liabilities.
*   **Related Party Transactions:** Discloses transactions with entities or individuals that have a close relationship with the company (e.g., major shareholders, management, other companies controlled by management). These require scrutiny for potential conflicts of interest or non-arm's-length terms.

**Common Red Flags in Footnotes:**
*   Frequent changes in accounting policies or estimates.
*   Complex or opaque language, especially in critical areas like revenue recognition or special purpose entities.
*   Significant Level 3 assets in fair value measurements.
