...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mainIndexSearch && primerSummaryCards.length > 0 && primerContentDisplay) {
        ...
        if (primerContentDisplay) {
             if (primerSummaryCards.length > 0 && primerSummaryCards[0].dataset.mdSrc) { // Typo: primerCards -> primerSummaryCards
                // loadAndDisplayMarkdown(primerSummaryCards[0].dataset.mdSrc, primerContentDisplay, primerSummaryCards[0]); // Uncomment to load first primer
